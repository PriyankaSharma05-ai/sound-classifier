...
This project builds a **Bird Sound Classification System** using **Deep Learning (CNN)**.
The system analyzes uploaded audio recordings of bird calls and predicts the bird species.
